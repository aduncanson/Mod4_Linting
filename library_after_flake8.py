...
class Library():
    ...
    def __init__(
            self, libraryOwner=None,
            libraryCoowner=None, libraryName=None):
    ...
    def printTheOwners(self):
        if self.libraryCoowner == "":
            print("The owner of '" + self.libraryName +
                  "' is " + self.libraryOwner + ".")
        else:
            print("The owners of '" + self.libraryName + "' are " +
                  self.libraryOwner + " and " + self.libraryCoowner + ".")
